		...
		<div class="container">
			...
			<div class="panel panel-default">
				...
				<div class="panel-body">
					<form name="name_of_customer" method="post" id="order_process_form" action="https://www.baimmobilier.fr/eko/stripe/payment.php">
						<div class="row">
							<div class="col-md-8" style="border-right:1px solid #ddd;">
								<h4 style="text-align=center">Info Clients</h4>
								<div class="form-group">
									<label><b>Nom Client <span class="text-danger">*</span></b></label>		        
									<? 
										$var = $_SESSION["user"]["nom"];
										echo "<input type='text' name='customer_name' id='customer_name' class='form-control' value='$var' readOnly='readOnly'/>";
									?>
	    						...
	    						<div class="form-group">
	    							<label><b>Adresse Postale <span class="text-danger">*</span></b></label>
	    						...
	    						<div class="row">
	    							...
	    							<div class="col-sm-6">
	    								<div class="form-group">
	    									<label><b>Code Postale <span class="text-danger">*</span></b></label>
	    						...
	    						<hr />
	    						<h4 style="text-align=center">Détails du Payment</h4>
	    						<div class="form-group">
								...
								<div style="text-align=center">
									...
									<input type="button" name="button_action" id="button_action" class="btn btn-success btn-sm" onclick="stripePay(event)" value="Payer" />
								</div>
								<br />
							</div>
							<div class="col-md-4">
...
Stripe.setPublishableKey('pk_test_51MVI6oGUygaHYSJ3HFkbVseGrf5zi0xJsSJHXsZA1IRNGxTWUK7WvyPXeqGP1kgCUiiy7dvNXmJNckb8jjV6RKtv001K3Wo87e');
